...
class JobMatcher:
    ...
    async def convert_skills_to_keywords(self, skills: List[str]) -> List[str]:
        ...
        skill_keyword_map = {
            ...
            'photoshop': ['photoshop', 'graphic design', 'designer'],
            'illustrator': ['illustrator', 'graphic design', 'designer'],
            'premiere pro': ['premiere pro', 'video editor', 'video production'],
            'premier pro': ['premiere pro', 'video editor', 'video production'],
            'capcut': ['capcut', 'video editor', 'video production'],
            'canva': ['canva', 'graphic design', 'content creator'],
            'video production': ['video production', 'video editor', 'content creator'],
            'video editing': ['video editor', 'video production', 'content creator'],
            'podcast creation': ['podcast producer', 'audio editor', 'content creator'],
            'podcasting': ['podcast producer', 'audio editor', 'content creator'],
            'content creation': ['content creator', 'social media marketing', 'branding'],
            ...
            'risk management': ['risk management', 'operations', 'project management'],
            ...
            'performance marketing': ['performance marketing', 'digital marketing', 'paid ads'],
            'social media marketing': ['social media marketing', 'social media manager', 'digital marketing'],
            'content marketing': ['content marketing', 'copywriter', 'content strategist'],
            'seo': ['seo', 'search engine optimization'],
            'sem': ['sem', 'search engine marketing', 'paid ads'],
            'sales': ['sales', 'business development'],
            'customer support': ['customer support', 'client support'],
            'content writing': ['content writer', 'copywriter'],
            'copywriting': ['copywriter', 'content writer', 'marketing'],
            'content strategy': ['content strategist', 'content marketing'],
            'branding': ['branding', 'brand manager', 'marketing'],
            'google analytics': ['google analytics', 'web analytics', 'digital marketing'],
            'hubspot': ['hubspot', 'crm', 'marketing automation'],
            'facebook meta suite': ['meta ads', 'facebook ads', 'social media marketing'],
            'meta ads': ['meta ads', 'facebook ads', 'instagram ads'],
            'facebook ads': ['facebook ads', 'meta ads', 'paid ads'],
            'instagram ads': ['instagram ads', 'meta ads', 'paid ads'],
            'tiktok ads': ['tiktok ads', 'paid ads', 'social media marketing'],
            'google ads': ['google ads', 'sem', 'paid ads'],
            'crm': ['crm', 'customer relationship management'],
            'marketing automation': ['marketing automation', 'hubspot', 'crm'],
            ...
            # Soft / cross-functional strengths
            'problem solving': ['problem solving', 'analytical thinking'],
            'organizational skills': ['operations', 'coordination', 'project management'],
            'multitasking': ['operations', 'coordination', 'executive assistant'],
            'teamwork': ['team collaboration', 'cross-functional'],
            'self starter': ['self starter', 'startup', 'operations'],
            'startup vision': ['startup', 'business development', 'operations'],
        }
