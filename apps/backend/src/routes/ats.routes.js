...
router.post('/score-file', uploadLimiter, uploadResume, handleUploadErrors, atsController.scoreUploadedResume);

// POST /ats/optimize-file - Optimize uploaded resume
router.post('/optimize-file', uploadLimiter, aiLimiter, uploadResume, handleUploadErrors, atsController.optimizeUploadedResume);
...
router.post('/recommend-jobs-file', uploadLimiter, aiLimiter, uploadResume, handleUploadErrors, atsController.recommendJobsForUploadedResume);

// POST /ats/jd-match - Match resume with job description
router.post('/jd-match', uploadLimiter, aiLimiter, uploadResume, handleUploadErrors, atsController.matchWithJD);
